...
url | no | **string** <br />The full URL to the prospect on Overloop.ai
...
that will return an existing prospect if a prospect with that email or LinkedIn profile already exists (with 200 HTTP status code, 422 otherwise).
